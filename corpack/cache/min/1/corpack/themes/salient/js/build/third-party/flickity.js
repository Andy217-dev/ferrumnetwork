  ...
  (function (t, e) {
    ...
    n.extend(p, e.prototype),
      (p._create = function () {
        ...
        var i = this;
        for (var n in (t.addEventListener("orientationchange", function () {
          i.nectarOrientationChanged = !0;
        }),
        (this.options.resize || this.options.watchCSS) &&
          t.addEventListener("resize", this),
        this.options.on)) {
          var s = this.options.on[n];
          this.on(n, s);
        }
      ...
      (p._createSlider = function () {
        if (this.$element.hasClass("generate-markup")) {
          ...
          (t.className = "flickity-slider"),
            ...
            (this.slider = t);
        } else this.slider.style[this.originSide] = 0;
      }),
      ...
      (p.reloadCells = function () {
        if (
          a(this.slider).parent().parent().find(".flickity-page-dots").length >
          0
        ) {
          var t = this;
          setTimeout(function () {
    ...
    return (
      ...
      (p.focus = function () {
        ...
        this.element.focus({ preventScroll: !0 }),
          t.pageYOffset != e && e > 10 && t.scrollTo(t.pageXOffset, e);
      }),
