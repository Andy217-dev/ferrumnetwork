          ...
          this.current.$slide.trigger("onReset"),
            ...
            this.current.opts.backFocus &&
              ...
              s &&
                ...
                (i = t.scrollY),
                s.trigger("focus"),
                n("html, body").scrollTop(i).scrollLeft(0))),
            (this.current = null),
    ...
    t(document).on("objectNeedsType.fb", function (o, i, s) {
      ...
      (a = t.extend(!0, {}, e, s.opts.media)),
        t.each(a, function (e, o) {
          ...
          if ("vimeo" === e && i && i[3] && i[4]) {
            var a = void 0 !== i[5] && i[5] ? i[5].replace("?", "&") : "",
              g = t.param(o.params, !0);
            return (
              (f =
          ...
          if ((c = f.match(o.matcher))) {
            if (
              ...
              for (var b = 0; b < h.length; ++b) {
                var m = h[b].split("=", 2);
                2 == m.length &&
                  (d[m[0]] = decodeURIComponent(m[1].replace(/\+/g, " ")));
              }
            }
            return (
