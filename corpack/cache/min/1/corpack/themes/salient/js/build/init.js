!(function (t, e, a) {
      ...
      r.hasClass("nectar-auto-lightbox") &&
        ...
        t(".main-content img").each(function () {
          t(this).parent().is("[href]") &&
            ...
            0 == t(this).parents(".woocommerce-product-gallery").length &&
            0 == t(this).parents(".wpb_gallery_slides.wpb_flexslider").length &&
    ...
    setTimeout(function () {
      ...
      t('body[data-ls="pretty_photo"]').length > 0
        ...
        : t('body[data-ls="fancybox"]').length > 0 &&
          (t().fancybox ? se() : setTimeout(se, 200));
    }, 60);
  }
  function oe() {
    ...
    r.on("click", ".tabbed > ul li:not(.cta-button) a", function (a) {
      if (
        ((function (a) {
          ...
          c.find(".nectar-progress-bar").length > 0 && Qe(),
            ...
            (c.find(".parallax-layer").length > 0 ||
              ...
              Fe(),
            Se(),
            c.find(".nectar-milestone").length > 0 && de(),
            ...
            c.find(".nectar-fancy-ul").length > 0 && ke(),
            c.find(".nectar-split-heading").length > 0 && Ne(),
            c.find('.wpb_column[data-border-animation="true"]').length > 0 &&
              Ze(),
            c.find(".wpb_animate_when_almost_visible").length > 0 && oe(),
            c.find(".nectar-animated-title").length > 0 && ha(),
            c.find(".nectar-highlighted-text").length > 0 && ua(),
            c.find(".nectar_food_menu_item").length > 0 && Ue(),
            c.find('.nectar-post-grid:not([data-animation="none"])').length >
              0 && ca(),
            c.find(".nectar-waypoint-el").length > 0 && Ge(),
            ...
            0,
            a.parent().parent().find(".magic-line").length > 0 && ce(a),
      ...
      t(
        ...
        t(this).is("[data-n-parallax-bg][data-parallax-speed]")
          ? ((R[e] = new He(
              t(this),
              ".parallax-layer",
              We(t(this).attr("data-parallax-speed")),
              "regular"
            )),
            e++)
          : 0 == t(this).find('[data-parallax-speed="fixed"]').length &&
            (t(this).hasClass("nectar-slider-wrap")
              ...
              : (R[e] = new He(
                  t(this),
                  ".row-bg.using-image",
                  We(t(this).find(".row-bg").attr("data-parallax-speed")),
                  "regular"
                )),
            e++),
  ...
  function sa() {
    ...
    if ("IntersectionObserver" in e) {
      s.off("resize.nectarLazySizing", ra),
        s.on("resize.nectarLazySizing", ra),
        ...
        ? t(".testimonial_slider").each(function (e) {
            var a = t(this),
              n = t(this).is("[data-style]")
                ...
                : "none";
            (G[e] = new NectarTestimonialSlider(a, n, $a, qe)),
              t(this).is(
  ...
  function ma() {
    s.off("smartresize.nectarTestimonials"),
      ...
      G.length > 0 && s.on("smartresize.nectarTestimonials", va),
      t('.testimonial_slider[data-style="multiple_visible_minimal"]').length >
        0 && s.on("resize.nectarTestimonialsMin", ba);
  }
  function va() {
    ...
    if (
      ...
      0 == t('#header-outer[data-permanent-transparent="1"]').length &&
        ...
        0 == t('#header-outer[data-remove-fixed="1"]').length &&
          ...
          dt &&
          (1 == k
            ? (s.off("scroll", mn), s.off("scroll", gn))
            : (s.off("scroll", vn), s.off("scroll", bn)))),
      pt.usingMobileBrowser)
    )
      return !1;
  ...
  function Ba(a) {
    ...
    ("left" !==
      ...
      s.off("mousemove.rightOffsetCheck", Ba),
          ...
          (1 == k
            ? (s.off("scroll.headerResizeEffect"),
              0 == pt.scrollTop
                ...
                : s.on("scroll.headerResizeEffect", mn))
  ...
  function Pa() {
    function a() {
      ...
      return (
        ...
        t(this).hasClass("simple-mobile-menu")
          ? (qa("simple-mobile-menu"), t(this).find("a").addClass("open"), !1)
          : (o.hasClass("slide-out-from-right")
              ? (function () {
                  ...
                  if (0 == t("body.material").length) {
                    ...
                    if (
                      ...
                      var u =
                        t("#logo img:visible").length > 0
                          ...
                          : t("#logo").width();
                      t("header#top nav > .sf-menu").offset().left - u - 300 <
                    ...
                    t("body.material").length > 0 &&
                      (p.length > 0 &&
                        t(".ocm-effect-wrap #ajax-loading-screen").length > 0 &&
              ...
              ? (function () {
                  t("body.material").length > 0 &&
                    t("header#top .slide-out-widget-area-toggle a").addClass(
                      "menu-push-out"
                    );
                  var e = 0,
                    a = 0;
                  pt.scrollTop + s.height() > t(".blurred-wrap").height() &&
                    ...
                    t("#slide-out-widget-area.fullscreen")
                      .show()
                      .addClass("open"),
                    0 == t(".nectar-social.fixed").length && Qn(),
                    t(".container-wrap").addClass("no-shadow"),
                    d.stop(!0).css("transform", "translateY(0)"),
                    setTimeout(function () {
                      t(".off-canvas-menu-container .menu > li").each(function (
                        e
                      ) {
                        t(this)
                          .delay(50 * e)
                  ...
                  var n =
                    d.offset().top - pt.scrollTop + pt.secondaryHeaderHeight;
                  t("#slide-out-widget-area.fullscreen > .inner-wrap").css(
                    "padding-top",
                    d.outerHeight() + n
                  );
                })()
              : o.hasClass("fullscreen-alt") || o.hasClass("fullscreen-split")
              ? (function () {
                  ...
                  l.hasClass("solid") && (a = 1),
                    ...
                    ".fullscreen-alt" === e &&
                      ...
                      Ma()),
                    setTimeout(function () {
                      t(".slide-out-widget-area-toggle > div > a").removeClass(
                        "animating"
                      );
                    }, 600),
                    t(
                    ...
                    setTimeout(
                      function () {
                        d
                          ...
                          0 ===
                            t('body[data-contained-header="true"]').length &&
                            setTimeout(function () {
                              anime({
              ...
              : t("#header-outer #mobile-menu").length > 0 &&
                ((a = 150), qa("slide-out-widget-area-toggle")),
            (gt.ocmAnimating = !0),
            setTimeout(function () {
              gt.ocmAnimating = !1;
            }, a),
    ...
    if (
          ...
          if (
            ...
            return (
              ...
              t(this).parents(".simple-mobile-menu").length > 0
                ? (ja("simple-mobile-menu"), t(this).removeClass("open"), !1)
                : (t(
                  ...
                  o.hasClass("slide-out-from-right")
                    ...
                    : t("#header-outer #mobile-menu").length > 0 &&
                      ja("slide-out-widget-area-toggle"),
                  0 == t("#header-outer #mobile-menu").length &&
      ...
      var i = Ya(n);
      t(".nectar-ocm-image." + i).length > 0 &&
        (t(".nectar-ocm-image.default").remove(),
        t(".nectar-ocm-image." + i).addClass("current")),
        ...
        ? (function () {
            ...
            if (
              ...
              0 === t(".ios-ocm-style").length &&
                t(
                  '<div class="slide-out-widget-area-toggle slide-out-hover-icon-effect" data-icon-animation="simple-transform"><div> <a href="#slide-out-widget-area" role="button" class="closed"> <span> <span class="screen-reader-text">' +
            ...
            if (pt.usingMobileBrowser || 0 != t(".ios-ocm-style").length) {
              ...
              r.on(
                ...
                r.on("click", "#slide-out-widget-area-bg", La),
                r.on(
                  "click",
  ...
  (le.prototype.setup = function () {
        ...
        for (t = 0; t < this.$parallaxEl.length; t++)
          !0 === this.firstSection
            ? (this.$parallaxEl[t].style.transform =
                "translate3d(0, " + pt.scrollTop * this.speed + "px, 0)")
            : (this.$parallaxEl[t].style.transform =
                "translate3d(0, " +
    ...
    t(e).on("salient-parallax-el-recalculate", Se),
    (Ae.prototype.setupProps = function () {
      var t = JSON.parse(
    ...
    t(e).on("salient-parallax-bg-recalculate", Fe),
    (Xe.prototype.calculatePos = function () {
      1 != gt.materialOffCanvasOpen &&
        1 != gt.ocmAnimating &&
        ((this.offsetTop = this.$element.offset().top),
        (this.height = this.$element.outerHeight()),
    ...
    t(e).on("salient-lazyloading-image-reinit", ra),
    (da.prototype.initialMarkup = function () {
                  ...
                  l
                    ...
                    .each(function (e) {
                      t(this).find(".nectar-split-heading").length > 0 &&
                        Mn(t(this).find(".nectar-split-heading"));
                      var n = t(this);
                      setTimeout(function () {
                        n.addClass("animated-in"),
      ...
      (function () {
        if (
          ...
          0 == t('#header-outer[data-permanent-transparent="1"]').length &&
            ...
            t(
              ".main-content > .row > .wpb_row, #full_width_portfolio #portfolio-extra > .wpb_row"
            ).each(function () {
              var a,
                n = t(this);
              new Waypoint({
    ...
    wt(),
      ...
      0 !== t(".team-member").length &&
        ...
        (t('.team-member[data-style="bio_fullscreen"]').length > 0 ||
          ...
          (s.on("resize", _e), !pt.usingMobileBrowser)) &&
      ...
      t(".morphing-outline").length > 0 &&
        (setTimeout(xe, 100), setTimeout(qe, 125), s.on("smartresize", xe)),
      (j = []),
      pt.usingMobileBrowser ||
    ...
    if (
            ...
            !(function (e) {
              if (
                ...
                if (
                  ...
                  0 ==
                    t("#header-outer .cart-notification .item-name").text()
                      .length
                )
                  return;
      ...
      (function () {
        if (0 != t("body.woocommerce-account #customer_login").length) {
          0 === t("#customer_login .nectar-form-controls").length &&
  ...
  function un() {
    t("#nectar_fullscreen_rows").length > 0 &&
      ...
      0 == t(".nectar-box-roll").length
        ? Ja()
        : t("#nectar_fullscreen_rows").length > 0 && 0 == lt && Ja();
  }
  (t.fn.dlmenu = function (e) {
      ...
      this.each(function () {
        ...
        n
          ? t.isFunction(n[e]) && "_" !== e.charAt(0)
            ? n[e].apply(n, a)
            : Na("no such method '" + e + "' for menu instance")
          : Na(
    ...
    (nn.prototype.updateQuantityCallback = function (n, i) {
      ...
      if (
        ...
        s.append(n.subtotal),
        e.nectarOptions &&
          e.nectarOptions.woo_using_cart_addons &&
          "true" === e.nectarOptions.woo_using_cart_addons &&
          n.item_price &&
          n.item_price.length > 0)
      ) {
        var r = t(n.item_price),
          o = i.$qty
            .closest(".woocommerce-mini-cart-item")
            .find(".product-price");
        r.text() !== o.find(".woocommerce-Price-amossunt").text() &&
          (o.find(".woocommerce-Price-amount, > del, > ins").remove(),
      ...
      !0 === i.state.removeFlag &&
        ...
        t("#header-outer a.cart-contents .cart-wrap span").length > 0 &&
          t("#header-outer a.cart-contents .cart-wrap span").text(n.item_count),
        t("#header-outer #mobile-cart-link .cart-wrap span").length > 0 &&
          t("#header-outer #mobile-cart-link .cart-wrap span").text(
            n.item_count
          );
    }),
  ...
  function fn() {
    ...
    (pn.bodyOffsetHeight = a.body.offsetHeight),
      0 == pn.init &&
        setInterval(function () {
          1 != gt.materialOffCanvasOpen &&
            (pn.bodyOffsetHeight = a.body.offsetHeight);
        }, 1500),
      (pn.raf = requestAnimationFrame(function a() {
        ...
        if (
          ...
          return (
            o > n &&
              ...
              (e = pt.scrollTop),
              (o = pt.scrollTop)),
            void (pn.raf = requestAnimationFrame(a))
          );
        ...
        if (
          ...
          pt.winH + pt.scrollTop + 30 >= pn.bodyOffsetHeight &&
  ...
  function mn() {
    ...
    1 != $ || pt.usingMobileBrowser || (n = 0),
      ((e <= n && a >= 1e3) ||
        ...
        s.off("scroll.headerResizeEffect", mn),
        s.on("scroll.headerResizeEffect", gn),
        t('#header-outer[data-transparent-header="true"]').css(
          "transition",
          "transform 0.3s ease, background-color 0.30s ease, opacity 0.3s ease, box-shadow 0.30s ease, margin 0.25s ease-out, backdrop-filter 0.25s ease"
  ...
  function vn() {
    (t(
      ...
      (pt.scrollTop > 0 &&
        ...
        s.on("scroll.headerResizeEffectOpaque", bn)));
  }
  function bn() {
    (t(
      '#header-outer[data-format="centered-menu-bottom-bar"][data-condense="true"]'
      ...
      (0 == pt.scrollTop &&
        ...
        t("body.material").length > 0 &&
          ...
          c.length > 0 &&
            ...
            (c.removeClass("hide-up"),
            d.removeClass("hide-up").css("transform", "translateY(0%)"))),
        s.off("scroll.headerResizeEffectOpaque", bn),
        s.on("scroll.headerResizeEffectOpaque", vn)));
  }
  function wn() {
    1 != gt.materialOffCanvasOpen
      ? (pt.scrollTop > 5
        ...
        pt.winW < 1e3 && requestAnimationFrame(wn))
  ...
  function yn() {
    pt.winW > 999 ||
      ...
      s.on("smartresize.nectarNavScrollEffects", _n));
  }
  function _n() {
    pt.winW < 1e3 ||
      (1 == k && "1" != I
        ...
        : "1" == I &&
          ...
          0 == t('#header-outer[data-remove-fixed="1"]').length &&
            (cancelAnimationFrame(pn.raf), fn())),
      t(
        '#header-outer[data-format="centered-menu-bottom-bar"][data-condense="true"]'
      ).length > 0 &&
  ...
  function Bn() {
    if (t(".nectar-recent-posts-slider-inner").length > 0) {
      ...
      a.on("dragStart.flickity", function () {
        ...
        zn(),
        s.on("resize", zn),
        pt.usingMobileBrowser || pt.usingFrontEndEditor || s.on("resize", Ln);
    }
          ...
          .each(function (e) {
            ...
            n.find(".controls").append(
              "<li " +
                a +
                '><span class="title">' +
                t(this).find(".large-featured-post-title").text() +
                "</span></li>"
            );
          }),
    ...
    t().flickity
      ...
      pt.usingMobileBrowser ||
        (t(".nectar-recent-posts-slider").length > 0 &&
          !pt.usingFrontEndEditor &&
          e.requestAnimationFrame(Fn)),
      pt.usingMobileBrowser || pt.usingFrontEndEditor || Ln();
  }
  function jn() {
  ...
  function Rn() {
    if (
      ...
      t(".nectar_video_player_self_hosted").each(function (e) {
        !pt.usingMobileBrowser &&
          ...
          (P[e] = new Yn(t(this), ".play_button.follow_mouse .play"));
      }),
      "IntersectionObserver" in e)
    ) {
      var n = new IntersectionObserver(
    ...
    t(".nectar-video-box").each(function (e) {
      if (t(this).find(".play_button_mouse_follow").length > 0) {
        ...
        t(this).imagesLoaded(function () {
          pt.usingMobileBrowser ||
            (P[e] = new Yn(a, ".play_button_mouse_follow"));
          var t =
  ...
  function Nn() {
    t(".infinite_scroll").length > 0 &&
        ...
        function (e) {
          ...
          t(e)
            ...
            .imagesLoaded(function () {
              ...
              if (
                (t(e).find(".work-item.style-5").length > 0 && jn(),
      ...
      t(".post-area.infinite_scroll .posts-container").infinitescroll(
        ...
        function (e) {
          t(e).find("[data-nectar-img-src]").length > 0 && sa(),
  ...
  function Zn() {
    if (
      (0 == t(".nectar-social.fixed").length &&
        ...
        (pt.scrollTop > 350 ? s.on("scroll", Qn) : s.on("scroll", Dn)),
        ...
        t("#header-outer")
          ...
          .each(function () {
            "#" !== t(this).attr("href") &&
              ...
              "#slide-out-widget-area" !== t(this).attr("href") &&
              (n = !0);
          }),
      t("#slide-out-widget-area .off-canvas-menu-container").length > 0 &&
        t("#slide-out-widget-area .off-canvas-menu-container")
  ...
  function Un() {
    ...
    if (
      ...
      t(".nectar-box-roll").length > 0 &&
        ...
        t("img[data-nectar-img-src]").length > 0 && (aa(), (u = 200)),
        setTimeout(function () {
          var e;
          if (!0 === E) {
            var n =
  ...
  function Jn() {
    ...
    t(".portfolio-items:not(.carousel)").each(function (a) {
      if (
        ...
        (M[e] = new SalientPortfolio(t(this), qe, ot, Ee)), e++;
      else {
        var n = t(this);
    ...
    if (t("#nectar_fullscreen_rows").length > 0 && t().fullpage) {
      ...
      pt.usingMobileBrowser || (a = "off"),
        ...
        "undefined" != typeof NectarFullScreenRows &&
          (ut = new NectarFullScreenRows(tn, U, si, pt, Ke, K, W, tt));
    ...
    t(".wpb_row").removeClass("only-ns"),
      ...
      t(
        ...
        if (t(this).find("> .vc_element-container > div").length > 0) {
          ...
          a.is(".vc_vc_row_inner")
            ? a.addClass("first-inner-row-el")
            : e.find("> div").removeClass("first-inner-row-el");
        }
      }),
  ...
  function fi() {
    setTimeout(function () {
      t("body.compose-mode").length > 0 &&
        ...
        pt.usingFrontEndEditor &&
          (ui(),
          r.is('[data-flex-cols="true"]') || (pi(), s.on("smartresize", pi)));
    }, 200),
      s.on("vc_reload", function () {
        ...
        (W = []),
          ...
          ii(),
          void 0 !== e.Waypoint && (Waypoint.destroyAll(), tn());
      });
  }
  function gi() {
    var a = !1;
    if (
      ...
      1 == a &&
        p
          ...
          .addClass("loaded")
          .addClass("hidden"),
        0 != t(".nectar-box-roll").length || pt.usingFrontEndEditor || tn();
  }
  function mi(n) {
    var i, l, u, p, g;
    pt.usingMobileBrowser && pt.scrollPosRAF(),
      ...
      (function () {
        ...
        if (
          ...
          0 != t('body[data-header-format="left-header"]').length ||
            ...
            e.nectarOptions &&
              e.nectarOptions.dropdown_hover_intent &&
              "add" === e.nectarOptions.dropdown_hover_intent &&
              (n = !1),
          ...
          r.on(
            ...
            function () {
              return (
                ...
                t(this).hasClass("nectar-search-open-trigger") ||
      ...
      pt.winW < 1e3
        ...
        : (_n(), s.on("smartresize.nectarNavScrollEffects", _n)),
      ii(),
      ma(),
      Ce(),
      (i =
                    ...
                    setTimeout(function () {
                      ...
                      t('body[data-hhun="1"]').length > 0 &&
                        ...
                        f.parents('.page-submenu[data-sticky="true"]').length >
                          0 &&
                          (t("#header-outer.detached").addClass("invisible"),
                          t(".page-submenu")
                            .addClass("header-not-visible")
                            .css("transform", "translateY(0px)")));
                      var p,
