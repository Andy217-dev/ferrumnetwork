...
void 0 !== headerEl &&
  ...
  jQuery(function (e) {
    ...
    if (
      ...
      (t = e("#page-header-bg")), h();
      var l = window.innerWidth,
        s = window.innerHeight;
      e(window).resize(function () {
        e(window).width() != l &&
          e(window).height != s &&
          (h(), (l = window.innerWidth), (s = window.innerHeight));
      });
    }
    i &&
      e(".nectar_fullscreen_zoom_recent_projects").length > 0 &&
      ((a =
        e(".body-border-top").length > 0 && e(window).width() > 1e3
          ? e(".body-border-top").height()
          : 0),
      e(".nectar_fullscreen_zoom_recent_projects").each(function () {
        e(this).parents(".first-section").length > 0
          ? e(this).css("height", e(window).height() - e(this).offset().top - a)
      ...
      e('#header-outer[data-format="centered-menu-bottom-bar"]').length > 0 &&
        ...
        (d = n.find("#logo").clone()).is('[data-supplied-ml="true"]') &&
          d.find("img:not(.mobile-only-logo)").remove(),
        d.find("img.starting-logo").remove(),
        o.length > 0 && o.addClass("centered-menu-bottom-bar"),
        d.removeAttr("id").addClass("logo-clone"),
        e('#header-outer[data-condense="true"]').length > 0 &&
          0 == e('#header-outer[data-menu-bottom-bar-align="left"]').length &&
          r.prepend(d)),
      e('#page-header-bg[data-animate-in-effect="zoom-out"]').addClass(
        "loaded"
      );
  });
